...
class DataTransformation:
    ...
    def print_class_distribution(self, distribution):
        """
    ...
    def calculate_class_distribution_tf(
        ...
        try:
            ...
            class_names = dataset.map(lambda x: self.extract_class_from_path_tf(x))
    ...
    def collect_and_combine_images(
        ...
        try:
            ...
            train_images_paths = self.collect_images_with_regex_and_count(train_path, classes, pattern_regex)
            ...
            valid_images_paths = self.collect_images_with_regex_and_count(valid_path, classes, pattern_regex)
            custom_title_print(f"=")
            print()
